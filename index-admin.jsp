...
<%@include file="/WEB-INF/getLisths.jsp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<style type="text/css">
<%@include file="/WEB-INF/css/estilo-index.css" %>
</style>
...
<body>
	...
	<div id='barra'>
		<ul id='opciones'>			
			<li><a href="index-admin">Bienvenido</a></li>
		...
		<ul id='opciones1'>
			...
			<li><a href="usuarios.jsp">Vista Usuarios</a></li>					
		</ul>	
	</div>
	<div id='cuerpo'>
		<br>
